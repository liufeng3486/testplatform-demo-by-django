...
function dTree(objName) {
	...
	this.icon = {
		root				: '../../static/gif/base.gif',
		folder			: '../../static/gif/folder.gif',
		folderOpen	: '../../static/gif/folderopen.gif',
		node				: 'img/page.gif',
		empty				: '../../static/gif/empty.gif',
		line				: '../../static/gif/line.gif',
		join				: '../../static/gif/join.gif',
		joinBottom	: '../../static/gif/joinbottom.gif',
		plus				: '../../static/gif/plus.gif',
		plusBottom	: '../../static/gif/plusbottom.gif',
		minus				: '../../static/gif/minus.gif',
		minusBottom	: '../../static/gif/minusbottom.gif',
		nlPlus			: '../../static/gif/nolines_plus.gif',
		nlMinus			: '../../static/gif/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
...
dTree.prototype.node = function(node, nodeId) {
	...
	if (this.config.useIcons) {
		...
		alert(((node._io) ? node.iconOpen : node.icon))
